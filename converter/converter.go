...
func KeyValue[T any](key string, value T) types.KeyValue[T] {
	return types.KeyValue[T]{Key: key, Value: value}
}

func KeyValuesToBson[T any](bsonElements ...types.KeyValue[T]) bson.D {
	value := bson.D{}
