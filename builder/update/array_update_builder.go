...
func (b *arrayUpdateBuilder) AddToSet(key string, value any) *Builder {
	...
	if !b.parent.tryMergeValue(AddToSetOp, e) {
		b.parent.data = append(b.parent.data, bson.E{Key: AddToSetOp, Value: bson.D{e}})
	}
	return b.parent
}
...
func (b *arrayUpdateBuilder) Pop(key string, value any) *Builder {
	e := bson.E{Key: key, Value: value}
	if !b.parent.tryMergeValue(PopOp, e) {
		b.parent.data = append(b.parent.data, bson.E{Key: PopOp, Value: bson.D{e}})
	}
	return b.parent
}
...
func (b *arrayUpdateBuilder) Pull(key string, value any) *Builder {
	e := bson.E{Key: key, Value: value}
	if !b.parent.tryMergeValue(PullOp, e) {
		b.parent.data = append(b.parent.data, bson.E{Key: PullOp, Value: bson.D{e}})
	}
	return b.parent
}
...
func (b *arrayUpdateBuilder) Push(key string, value any) *Builder {
	e := bson.E{Key: key, Value: value}
	if !b.parent.tryMergeValue(PushOp, e) {
		b.parent.data = append(b.parent.data, bson.E{Key: PushOp, Value: bson.D{bson.E{Key: key, Value: value}}})
	}
	return b.parent
}

func (b *arrayUpdateBuilder) PullAll(key string, values ...any) *Builder {
	b.parent.data = append(b.parent.data, bson.E{Key: PullAllOp, Value: bson.D{bson.E{Key: key, Value: values}}})
	return b.parent
}
...
func (b *arrayUpdateBuilder) PullAllUint8(key string, values ...uint8) *Builder {
	b.parent.data = append(b.parent.data, bson.E{Key: PullAllOp, Value: bson.D{{Key: key, Value: values}}})
	return b.parent
}
...
func (b *arrayUpdateBuilder) Each(values ...any) *Builder {
	b.parent.data = append(b.parent.data, bson.E{Key: EachOp, Value: values})
	return b.parent
}
...
func (b *arrayUpdateBuilder) Position(value int) *Builder {
	b.parent.data = append(b.parent.data, bson.E{Key: PositionOp, Value: value})
	return b.parent
}

func (b *arrayUpdateBuilder) Slice(num int) *Builder {
	b.parent.data = append(b.parent.data, bson.E{Key: SliceForUpdateOp, Value: num})
	return b.parent
}

func (b *arrayUpdateBuilder) Sort(value any) *Builder {
	b.parent.data = append(b.parent.data, bson.E{Key: SortOp, Value: value})
	return b.parent
}
