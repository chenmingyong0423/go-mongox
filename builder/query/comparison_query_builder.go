...
func (b *comparisonQueryBuilder) Eq(key string, value any) *Builder {
	b.parent.data = append(b.parent.data, bson.E{Key: key, Value: bson.D{bson.E{Key: types.Eq, Value: value}}})
	return b.parent
}

func (b *comparisonQueryBuilder) Gt(key string, value any) *Builder {
	b.parent.data = append(b.parent.data, bson.E{Key: key, Value: bson.D{bson.E{Key: types.Gt, Value: value}}})
	return b.parent
}

func (b *comparisonQueryBuilder) Gte(key string, value any) *Builder {
	b.parent.data = append(b.parent.data, bson.E{Key: key, Value: bson.D{bson.E{Key: types.Gte, Value: value}}})
	return b.parent
}

func (b *comparisonQueryBuilder) In(key string, values ...any) *Builder {
	b.parent.data = append(b.parent.data, bson.E{Key: key, Value: bson.D{bson.E{Key: types.In, Value: values}}})
	return b.parent
}
...
func (b *comparisonQueryBuilder) Nin(key string, values ...any) *Builder {
	b.parent.data = append(b.parent.data, bson.E{Key: key, Value: bson.D{bson.E{Key: types.Nin, Value: values}}})
	return b.parent
}
...
func (b *comparisonQueryBuilder) Lt(key string, value any) *Builder {
	b.parent.data = append(b.parent.data, bson.E{Key: key, Value: bson.D{bson.E{Key: types.Lt, Value: value}}})
	return b.parent
}

func (b *comparisonQueryBuilder) Lte(key string, value any) *Builder {
	b.parent.data = append(b.parent.data, bson.E{Key: key, Value: bson.D{bson.E{Key: types.Lte, Value: value}}})
	return b.parent
}

func (b *comparisonQueryBuilder) Ne(key string, value any) *Builder {
	b.parent.data = append(b.parent.data, bson.E{Key: key, Value: bson.D{bson.E{Key: types.Ne, Value: value}}})
	return b.parent
}
