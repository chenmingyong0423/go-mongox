	...
	testCases := []struct {
	...
	}{
		{
			...
			mock: func(ctx context.Context, ctl *gomock.Controller) iCreator[types.TestUser] {
				...
				mockCollection.EXPECT().One(ctx, types.TestUser{
					Id:   "123",
					Name: "cmy",
					Age:  18,
...
func TestCreator_OneWithOptions(t *testing.T) {
	testCases := []struct {
		name string
		mock func(ctx context.Context, ctl *gomock.Controller) iCreator[types.TestUser]
		ctx  context.Context
	...
	}{
		{
			...
			mock: func(ctx context.Context, ctl *gomock.Controller) iCreator[types.TestUser] {
				mockCollection := mocks.NewMockiCreator[types.TestUser](ctl)
				mockCollection.EXPECT().OneWithOptions(ctx, types.TestUser{
					Id:   "123",
					Name: "cmy",
					Age:  18,
				}, []*options.InsertOneOptions{}).Return(nil, errors.New("duplicate key")).Times(1)
				return mockCollection
			},
			ctx:     context.Background(),
			doc:     types.TestUser{Id: "123", Name: "cmy", Age: 18},
...
func TestCreator_Many(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			mock: func(ctx context.Context, ctl *gomock.Controller) iCreator[types.TestUser] {
				mockCollection := mocks.NewMockiCreator[types.TestUser](ctl)
				mockCollection.EXPECT().Many(ctx, []types.TestUser{
					{
						Id:   "123",
						Name: "cmy",
						Age:  18,
...
func TestCreator_ManyWithOptions(t *testing.T) {
	testCases := []struct {
		name string
		mock func(ctx context.Context, ctl *gomock.Controller) iCreator[types.TestUser]
		ctx  context.Context
	...
	}{
		{
			...
			mock: func(ctx context.Context, ctl *gomock.Controller) iCreator[types.TestUser] {
				mockCollection := mocks.NewMockiCreator[types.TestUser](ctl)
				mockCollection.EXPECT().ManyWithOptions(ctx, []types.TestUser{
					{
						Id:   "123",
						Name: "cmy",
						Age:  18,
				...
				}, []*options.InsertManyOptions{}).Return(nil, errors.New("duplicate key")).Times(1)
				return mockCollection
			},
			ctx: context.Background(),
			doc: []types.TestUser{
